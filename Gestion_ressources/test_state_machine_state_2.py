...
def db_test(config_test):
    ...
    for elem in list_of_type_ressources:
        ...
        for i in range(4):
            ...
            r = Ressource(typeRessource=Type, Contact1=ressource["Contact1"], Contact2=ressource["Contact2"], State=2, State_chg=ressource["State_chg"] ,count_retries= i, loan_time=ressource["loan_time"])
            ressource["ID"] = r.id
...
def test_ressource_state_2_count_retries0_no_timeout(db_test):
    """
    {'State': 2, count_retries': 0, State_chg': inférieur au time out}
    devient
    {'State': 2, count_retries': 0, State_chg': ne doit pas avoir été modifié}
    """
    ...
    assert state_of_ressource_before == 2
    assert count_retries_of_ressource_before == 0    
...
def test_ressource_state_2_count_retries0_timeout(db_test):
    """
    {'State': 2, count_retries': 0, State_chg': supérieur au time out}
    devient 
    {'State': 2, count_retries': 1, State_chg': maintenant}
    """
    dic_ressources = db_test[1]
...
def test_ressource_state_2_count_retries1_no_timeout(db_test):
    """
    {'State': 2, count_retries': 1, State_chg': inférieur au time out}
    devient
    {'State': 2, count_retries': 1, State_chg': ne doit pas avoir été modifié}
    """
    dic_ressources = db_test[1]
    list_of_ressources = dic_ressources["type1"]
    ...
    assert state_of_ressource_before == 2
    assert count_retries_of_ressource_before == 1    
    assert state_of_ressource_before == state_of_ressource_after
    assert count_retries_of_ressource_before == count_retries_of_ressource_after
    assert  time_before == time_after


def test_ressource_state_2_count_retries1_timeout(db_test):
    """
    {'State': 2, count_retries': 1, State_chg': supérieur au time out}
    devient 
    {'State': 2, count_retries': 2, State_chg': maintenant}
    """
...
def test_ressource_state_2_count_retries2_no_timeout(db_test):
    """
    {'State': 2, count_retries': 2, State_chg': inférieur au time out}
    devient
    {'State': 2, count_retries': 2, State_chg': ne doit pas avoir été modifié}
    """
    dic_ressources = db_test[1]
    list_of_ressources = dic_ressources["type1"]
    ...
    assert state_of_ressource_before == 2
    assert count_retries_of_ressource_before == 2    
    assert state_of_ressource_before == state_of_ressource_after
    assert count_retries_of_ressource_before == count_retries_of_ressource_after
    assert  time_before == time_after

def test_ressource_state_2_count_retries2_timeout(db_test):    
    """
    {'State': 2, count_retries': 2, State_chg': supérieur au time out}
    devient 
    {'State': 2, count_retries': 3, State_chg': maintenant}
    """
    dic_ressources = db_test[1]
    list_of_ressources = dic_ressources["type2"]
    ID = list_of_ressources[2]['ID']
...
def test_ressource_state_2_count_retries3_no_timeout(db_test):
    """
    {'State': 2, count_retries': 3, State_chg': inférieur au time out}
    devient
    {'State': 2, count_retries': 3, State_chg': ne doit pas avoir été modifié}
    """
    dic_ressources = db_test[1]
    list_of_ressources = dic_ressources["type1"]
    ID = list_of_ressources[3]['ID']
    state_of_ressource_before = check_state_of_ressource(ID)
    count_retries_of_ressource_before = check_count_retries_of_ressource(ID)
    time_before = check_state_chg_of_ressource(ID)
    ...
    assert state_of_ressource_before == 2
    assert count_retries_of_ressource_before == 3  
    assert state_of_ressource_before == state_of_ressource_after
    assert count_retries_of_ressource_before == count_retries_of_ressource_after
    assert  time_before == time_after
    
def test_ressource_state_2_count_retries3_timeout(db_test):
    """
    {'State': 2, count_retries': 3, State_chg': supérieur au time out}
    devient 
    {'State': 3, count_retries': 3, State_chg': maintenant}
    """
    dic_ressources = db_test[1]
    list_of_ressources = dic_ressources["type2"]
    ID = list_of_ressources[3]['ID']
